...
<head>
    <meta charset="UTF-8">
    <title>Update Reservation | HMS</title>
    <style>
...
if (r == null) { response.sendRedirect("DisplayReservationsServlet"); return; }
%>
<div class="container">
    <a href="index.jsp" class="back-btn">&#8592; Back to Home</a>
    <h2>&#9998; Update Reservation #<%= r.getReservationID() %></h2>
    <div class="card">
        <form action="UpdateReservationServlet" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" name="totalAmount" value="<%= r.getTotalAmount() %>" step="0.01" min="0" required />
            </div>
            <div class="form-group">
    <label>Number of Guests</label>
    <input type="number" name="noOfGuests" value="<%= r.getNoOfGuests() %>" min="1" max="10" required />
</div>
